  ...
  const renderGraphicShippingMark = () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '5px', lineHeight: 1.3, padding: '8px 2px' }}>
        {shapeSvg}
        <div style={{ textAlign: 'center', textTransform: 'uppercase', color: '#000', marginTop: '6px', lineHeight: 1.4, letterSpacing: '0.3px' }}>
          <div style={{ fontSize: '15px', fontWeight: 900 }}>{portCountry}</div>
          <div style={{ fontSize: '15px', fontWeight: 900, margin: '2px 0' }}>{pltNo}</div>
          <div style={{ fontSize: '15px', fontWeight: 900 }}>{origin}</div>
        </div>
      </div>
    );
  };

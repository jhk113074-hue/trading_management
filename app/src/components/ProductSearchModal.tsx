      ...
      userSelect: isDragging ? 'none' : 'auto'
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-secondary)' }}>대분류</label>
            <select
          ...
          {/* Supplier Filter */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-secondary)' }}>공급사</label>
            <select
                ...
                filteredProducts.map((p) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px 8px' }}>
                      ...
                      <div style={{ fontSize: '11px', color: 'var(--text-secondary)', marginTop: '2px' }}>{p.nameEn || '-'}</div>
                    </td>
                    ...
                    <td style={{ padding: '12px 8px', textAlign: 'right', fontWeight: 600, color: '#0f172a' }}>
                      {p.purchasePrice ? (
                        <>
                          <span style={{ fontSize: '11px', color: 'var(--text-secondary)', marginRight: '4px' }}>{p.currency || 'USD'}</span>
                          {p.purchasePrice.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 2 })}
                        </>
                      ) : (
                        <span style={{ color: 'var(--text-muted)', fontSize: '12px' }}>미지정</span>
                      )}
                      <span style={{ fontSize: '11px', color: 'var(--text-secondary)', marginLeft: '4px' }}>/ {p.unit || 'KG'}</span>
                    </td>

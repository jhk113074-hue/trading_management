                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        {editForm.bizLicenseUrl ? (
                          ...
                          <div>
                            ...
                            <label htmlFor={`bizLicense_${comp.id}`} style={{ display: 'inline-block', padding: '6px 12px', background: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '0.8rem', cursor: 'pointer' }}>
                              {uploadingField === 'bizLicense' ? '업로드 중...' : '파일 선택'}
                            </label>
                          </div>
                        )}
                      </div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        {editForm.bankKrwUrl ? (
                          ...
                          <div>
                            ...
                            <label htmlFor={`bankKrw_${comp.id}`} style={{ display: 'inline-block', padding: '6px 12px', background: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '0.8rem', cursor: 'pointer' }}>
                              {uploadingField === 'bankKrw' ? '업로드 중...' : '파일 선택'}
                            </label>
                          </div>
                        )}
                      </div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        {editForm.bankForeignUrl ? (
                          ...
                          <div>
                            ...
                            <label htmlFor={`bankForeign_${comp.id}`} style={{ display: 'inline-block', padding: '6px 12px', background: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '0.8rem', cursor: 'pointer' }}>
                              {uploadingField === 'bankForeign' ? '업로드 중...' : '파일 선택'}
                            </label>
                          </div>
                        )}
                      </div>

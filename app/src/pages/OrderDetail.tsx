                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', borderBottom: '1px solid var(--border-color)', paddingBottom: '8px' }}>
                          ...
                          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
                            <button
                              ...
                              style={{ padding: '6px 12px', background: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1', borderRadius: '4px', fontWeight: 'bold', fontSize: '13px', cursor: isEditing ? 'pointer' : 'not-allowed' }}
                            >
                              + 컨테이너 추가
                            </button>
                          </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ display: 'flex', borderBottom: '2px solid var(--border-color)', gap: '8px', marginBottom: '8px' }}>
                {[
                  ...
                  { id: '업체별발행서류', label: '📦 업체별 발주서 / 도착보고서' },
              ...
              {/* ── 업체별 발주서 및 도착보고서 전용 서류 탭 ── */}
              {activeDocumentTab === '업체별발행서류' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  {/* 상단 안내 바 */}
              ...
              {activeDocumentTab === '서류업로드' && (
                <div style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
                  {/* 업체별 서류 빠른 열람 요약 배너 */}
                  <div style={{ width: '100%', background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '4px', padding: '10px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: '13px', fontWeight: 800, color: '#1e40af' }}>
                        📦 각 공급업체별 발주서 및 도착보고서 발행 현황 ({allOrderSuppliers.length}개사):
                      </span>
                      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                        {allOrderSuppliers.map(sup => (
                          <span key={sup} style={{ fontSize: '11px', background: '#fff', border: '1px solid #cbd5e1', borderRadius: '4px', padding: '2px 6px', fontWeight: 700, color: '#334155' }}>
                            {sup}
                          </span>
                        ))}
                      </div>
                    ...
                    <button
                      type="button"
                      onClick={() => updateQuery({ documentTab: '업체별발행서류' })}
                      style={{
                        background: '#2563eb',
                        color: '#fff',
                        border: 'none',
              ...
              {activeDocumentTab === 'CI_PL작성' && (() => {
                ...
                exportExcelRef.current = (overrideIncludeLetterhead?: boolean) => {
                  ...
                  exportCiPlToExcel({
                    ...
                    shippingMarkShape: commonShippingMark.shape || 'diamond',
                    shippingMarkCompany: commonShippingMark.company || 'YSACC',
                    shippingMarkPort: commonShippingMark.port || order.portOfDischarge || '',
                    shippingMarkCountry: commonShippingMark.country || order.destinationCountry || '',
                    shippingMarkPalletNo: palletNoText,
                    shippingMarkOrigin: commonShippingMark.origin || 'MADE IN KOREA',
                    customShipperText: customShipperVal,
                    containers: basicForm.packingList?.containers || [],

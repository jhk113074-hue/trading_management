        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '13px' }}>
          <thead style={{ backgroundColor: '#f1f5f9', borderBottom: '2px solid #e2e8f0' }}>
            <tr>
              ...
              <th onClick={() => handleSort('piDate')} style={{ padding: '12px', cursor: 'pointer' }}>DATE {getSortIcon('piDate')}</th>
              <th onClick={() => handleSort('createdByName')} style={{ padding: '12px', cursor: 'pointer' }}>WRITER {getSortIcon('createdByName')}</th>

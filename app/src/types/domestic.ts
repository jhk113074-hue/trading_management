export interface DomesticTradeItem {
  ...
  // Terms & Manager details
  specialNotes?: string;       // ※ 특고사항
  vatType?: string;            // 부가가치세 조건
  paymentTerms?: string;       // 결제 조건
  managerTitle?: string;       // 판매 담당자 직책
  managerName?: string;        // 판매 담당자 성명
  managerContact?: string;     // 판매 담당자 연락처

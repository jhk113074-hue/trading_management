...
export interface ImportRequest {
  ...
  piItems?: Array<{ name: string; qty: string; unitPrice: string; amount: string; buyingUnitPrice?: string; buyingAmount?: string; quoteUnitPrice?: string; quoteAmount?: string; marginRate?: string | number; currency?: string; hsCode?: string; unit?: string; palletSize?: string; cbm?: string; weight?: string; netWeight?: string; grossWeight?: string; productId?: string }>;
  incoterms?: string;
  paymentTerms?: string;
  pol?: string;
  pod?: string;

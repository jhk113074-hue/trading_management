...
export type TaskStatus = 'TODO' | 'PENDING' | 'IN_PROGRESS' | 'DONE' | 'HOLDING' | 'UPCOMING';
...
export interface ImportRequest {
  ...
  piItems?: Array<{ name: string; qty: string; unitPrice: string; amount: string; currency?: string; hsCode?: string; unit?: string; palletSize?: string; cbm?: string; weight?: string; netWeight?: string; grossWeight?: string; productId?: string }>;
  incoterms?: string;
  paymentTerms?: string;
  pol?: string;
  pod?: string;

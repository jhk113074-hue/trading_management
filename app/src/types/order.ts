...
export interface OrderItem {
  ...
  purchaseUnitCurrency?: "USD" | "KRW" | string;
  ...
  packingSpecOverride?: any;
  remarks?: string;
  salePriceUsd?: number;
  originalPurchasePrice?: number;
  originalPurchaseCurrency?: "USD" | "KRW" | string;
  amount: number;
...
export interface Order {
  ...
  bankCharges?: Array<{ date?: string; item: string; amount: number; receiptFiles?: Array<{ name: string; url: string; size: number; path: string }> }>; // BANK CHARGES(LC) 항목 및 금액
